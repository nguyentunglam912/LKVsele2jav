...
public class DA_MP_TC023 extends TestBase {
	/**
	 * DA_MP_TC023
	 * 
	 * @author khang.ha
	...
	public void DA_MP_TC023_CanEditParentNameSuccessfully() {
		...
		Log.info("Step 7: Click on " + Constant.PAGE_NAME1 + " page, click on Edit link, change name and click OK");
