...
public class DA_PANEL_TC056 extends TestBase {
	/**
	 * DA_PANEL_TC056
	 *
	...
	@Test
	@Description("Verify that user is unable to edit 'Folder' field with empty value")
	public void DA_PANEL_TC056_CannotEditFolderWithEmptyValue() {
		...
		panelPage.configPanel(null, null, this.emptyFolderPath);
